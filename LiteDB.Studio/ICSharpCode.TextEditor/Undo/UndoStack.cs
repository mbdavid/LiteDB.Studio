...
namespace LiteDB.Studio.ICSharpCode.TextEditor.Undo
{
    ...
    public class UndoStack
    {
        ...
        {
            if (undoGroupDepth == 0) actionCountInUndoGroup = 0;
            undoGroupDepth++;
        ...
        public void EndUndoGroup()
        {
            ...
            if (undoGroupDepth == 0 && actionCountInUndoGroup > 1)
            {
                ...
                undostack.Push(op);
                if (OperationPushed != null) OperationPushed(this, new OperationEventArgs(op));
            }
        }
        ...
        public void Push(IUndoableOperation operation)
        {
            ...
            if (AcceptChanges)
            {
                ...
                {
                    undostack.Push(new UndoableSetCaretPosition(this,
                        TextEditorControl.ActiveTextAreaControl.Caret.Position));
                    actionCountInUndoGroup++;
                }
        ...
        {
            if (ActionUndone != null) ActionUndone(null, null);
        }
        ...
        {
            if (ActionRedone != null) ActionRedone(null, null);
        }
