    ...
    public abstract class TextEditorControlBase : UserControl
    {
        ...
        public IDocument Document
        {
            ...
            set
            {
                ...
                if (document != null) document.DocumentChanged -= OnDocumentChanged;
                document = value;
        ...
        {
            if (!IsEditAction(keyData)) return null;
        ...
        public void LoadFile(string fileName, Stream stream, bool autoLoadHighlighting, bool autodetectEncoding)
        {
            ...
            if (autoLoadHighlighting)
                ...
                {
                    document.HighlightingStrategy =
                        HighlightingStrategyFactory.CreateHighlightingStrategyForFile(fileName);
                }
                catch (HighlightingDefinitionInvalidException ex)
                {
                    MessageBox.Show(ex.ToString(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
