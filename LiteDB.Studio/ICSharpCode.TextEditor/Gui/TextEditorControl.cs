...
namespace LiteDB.Studio.ICSharpCode.TextEditor.Gui
{
    ...
    public class TextEditorControl : TextEditorControlBase
    {
        ...
        {
            get => activeTextAreaControl.AutoHideScrollbars;
            set => activeTextAreaControl.AutoHideScrollbars = value;
        }
        ...
        [Browsable(false)] public bool EnableUndo => Document.UndoStack.CanUndo;

        [Browsable(false)] public bool EnableRedo => Document.UndoStack.CanRedo;
        ...
        protected void SetActiveTextAreaControl(TextAreaControl value)
        {
            if (activeTextAreaControl != value)
            {
                ...
                if (ActiveTextAreaControlChanged != null) ActiveTextAreaControlChanged(this, EventArgs.Empty);
            }
        }
        ...
        public override void OptionsChanged()
        {
            ...
            if (secondaryTextArea != null) secondaryTextArea.OptionsChanged();
        }
        ...
        public void Undo()
        {
            ...
            if (Document.UndoStack.CanUndo)
            {
                ...
                if (secondaryTextArea != null) secondaryTextArea.TextArea.UpdateMatchingBracket();
                EndUpdate();
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (textAreaPanel != null)
                {
                    ...
                    if (primaryTextArea != null) primaryTextArea.Dispose();
        ...
        public override void EndUpdate()
        {
            ...
            if (!IsInUpdate) ActiveTextAreaControl.Caret.OnEndUpdate();
        }
            ...
            foreach (var update in Document.UpdateQueue)
                switch (update.TextAreaUpdateType)
                {
                    case TextAreaUpdateType.PositionToEnd:
                        ...
                        if (secondaryTextArea != null) secondaryTextArea.TextArea.UpdateToEnd(update.Position.Y);
                        break;
                    ...
                    case TextAreaUpdateType.SingleLine:
                        ...
                        if (secondaryTextArea != null) secondaryTextArea.TextArea.UpdateLine(update.Position.Y);
                        break;
                    case TextAreaUpdateType.SinglePosition:
                        ...
                        if (secondaryTextArea != null)
                            secondaryTextArea.TextArea.UpdateLine(update.Position.Y, update.Position.X,
                                update.Position.X);
                        break;
                    ...
                    case TextAreaUpdateType.WholeTextArea:
                        ...
                        if (secondaryTextArea != null) secondaryTextArea.TextArea.Invalidate();
                        break;
                }
...
//						}
                    ...
                    case TextWordType.Tab:
                        Advance(ref xPos, ref yPos, maxWidth,
                            TabIndent * primaryTextArea.TextArea.TextView.WideSpaceWidth, fontHeight);
//						if (!gotNonWhitespace) {
//							curTabIndent = xPos;
//						}
                        break;
...
//						}
                        var drawingSize = g.MeasureString(word.Word, word.GetFont(fontContainer),
                            new SizeF(maxWidth, fontHeight * 100), printingStringFormat);
...
//			bool  gotNonWhitespace = false;
            ...
            foreach (var word in line.Words)
                ...
                {
                    case TextWordType.Space:
                        Advance(ref xPos, ref yPos, margin.Width, primaryTextArea.TextArea.TextView.SpaceWidth,
                            fontHeight);
//						if (!gotNonWhitespace) {
//							curTabIndent = xPos;
//						}
                        break;
                    case TextWordType.Tab:
                        Advance(ref xPos, ref yPos, margin.Width,
                            TabIndent * primaryTextArea.TextArea.TextView.WideSpaceWidth, fontHeight);
//						if (!gotNonWhitespace) {
//							curTabIndent = xPos;
//						}
...
//							curTabIndent    += TabIndent * primaryTextArea.TextArea.TextView.GetWidth(' ');
//						}
                        g.DrawString(word.Word, word.GetFont(fontContainer), BrushRegistry.GetBrush(word.Color),
                            xPos + margin.X, yPos);
                        var drawingSize = g.MeasureString(word.Word, word.GetFont(fontContainer),
                            new SizeF(margin.Width, fontHeight * 100), printingStringFormat);
        ...
        private void PrintPage(object sender, PrintPageEventArgs ev)
        {
            ...
            while (curLineNr < Document.TotalNumberOfLines)
            {
                ...
                if (curLine.Words != null)
                {
                    ...
                    if (drawingHeight + yPos > ev.MarginBounds.Bottom) break;
