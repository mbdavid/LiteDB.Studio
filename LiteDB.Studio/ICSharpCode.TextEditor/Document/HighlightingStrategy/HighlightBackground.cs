...
namespace LiteDB.Studio.ICSharpCode.TextEditor.Document.HighlightingStrategy
{
    ...
    public class HighlightBackground : HighlightColor
    {
        ...
        {
            if (el.Attributes["image"] != null) BackgroundImage = new Bitmap(el.Attributes["image"].InnerText);
        }

        /// <summary>
        ///     Creates a new instance of <see cref="HighlightBackground" />
        /// </summary>
        public HighlightBackground(Color color, Color backgroundcolor, bool bold, bool italic) : base(color,
            backgroundcolor, bold, italic)
        {
        }

        public HighlightBackground(string systemColor, string systemBackgroundColor, bool bold, bool italic) : base(
            systemColor, systemBackgroundColor, bold, italic)
        {
        }
